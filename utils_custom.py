...
def get_args(
        ...
        net="3Dresnet18",                    # Backbone used: "3Dresnet18"
        task_performed = "PIPNet",         # "Blackbox" or "PIPNet"
        ) -> argparse.Namespace:
    ...
    root_folder = "./"
    dataset_path = os.path.join(root_folder,"../data/FP_LR_OPNorm_avgcrop_DS32_point15Thresh.h5")
...
def set_device(args:argparse.Namespace):
    ...
    if args.gpu_ids!='':
        ...
        for m in range(len(gpu_list)):
            device_ids.append(int(gpu_list[m])) #wtf this shouldn't work
